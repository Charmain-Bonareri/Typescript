...
function changeName (){  //created a changeName function that takes the global variable name and 
...
var learning = "Today I am learning typesript on a Sunday"

function sundayLearning (){

    learning = "Learning typescript is actually fun!"
}
